...
public class AuthenticatedConnectListener implements WebSocketConnectListener {
  ...
  public void onWebSocketConnect(WebSocketSessionContext context) {
    ...
    System.out.println("pushSender::"+ pushSender);
    System.out.println("receiptSender::"+ receiptSender);
    System.out.println("messagesManager::"+ messagesManager);
    System.out.println("account::"+ account.getName()+"==="+account.getAvatar()+"==="+account.getNumber()+"==="+account.getIdentityKey());
    System.out.println("device::"+ device);
    System.out.println("context.getClient()::"+ context.getClient());
